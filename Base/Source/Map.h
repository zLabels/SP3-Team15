...
/*!
		Class CMap
\brief
Defines the variables and functions required for the tile map
...
public:
	...
	bool LoadMap(const string mapName);	//Loading map
	...
	vector<vector<int>> theScreenMap;	//2d vector of the map
...
private:
	...
	bool LoadFile(const string mapName);	//Loading file
};
